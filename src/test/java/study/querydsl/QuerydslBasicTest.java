...
//                .fetchFirst();
    ...
    /**
     * 예) 회원과 팅을 조인하면서, 팀 이름이 teamA인 팀만 조인, 회원은 모두 조회
     * JPQL: select m, t from Member m left m.team t on t.name = 'teamA'
     */
    @Test
    public void join_on_filtering() {
        List<Tuple> result = queryFactory
                ...
                .on(team.name.eq("teamA")) // inner join 에서는 where 로 filtering 하는 것과 동일한 효과
                .fetch();
